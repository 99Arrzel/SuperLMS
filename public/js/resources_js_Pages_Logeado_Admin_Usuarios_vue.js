...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    var form_u = (0,vue__WEBPACK_IMPORTED_MODULE_12__.reactive)({
      usuario: "",
      password: "",
    ...
    var filters = (0,vue__WEBPACK_IMPORTED_MODULE_12__.reactive)({
      global: {
        value: "",
        matchMode: primevue_api__WEBPACK_IMPORTED_MODULE_5__.FilterMatchMode.Contains
      }
    });
    var valores = (0,vue__WEBPACK_IMPORTED_MODULE_12__.reactive)({
    ...
    var submit = function submit() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_11___default().post(route(valores.accion == "Agregar" ? "dashboard_adm_usuarios_crear" : "dashboard_adm_usuarios_actualizar"), {
        ...
        if (response.data.success) {
          _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_10__.Inertia.reload({
            ...
            onSuccess: function onSuccess() {
              notiflix__WEBPACK_IMPORTED_MODULE_9__.Notify.success(response.data.message);
              notiflix__WEBPACK_IMPORTED_MODULE_9__.Loading.remove();
              valores.showModal = false;
            }
          });
        } else {
          notiflix__WEBPACK_IMPORTED_MODULE_9__.Notify.failure(response.data.message);
        }
      });
    };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["usuario"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [_hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DataTable, {
  ...
  , ["value", "filters", "selection"])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Dialog, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      , ["options", "modelValue"])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" submit "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        type: "submit",
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)($setup.valores.accion == 'Agregar' ? 'px-4 py-2 bg-green-500 text-white rounded-md' : 'px-4 py-2 bg-yellow-500 text-white rounded-md')
