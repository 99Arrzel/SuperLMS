            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div>
                    ...
                    <Calendar
                        dateFormat="dd/mm/yy"
                        class="w-full"
                        v-model="values.fecha_fin_f"
                    ></Calendar>
                </div>
            </div>
            <button
                class="rounded-lg p-2 w-full mt-2"
                :class="
                    values.accion_f == 'Añadir'
                ...
                <template #title>
                    ...
                    >
                        <button
                            ...
                            @click="editar_tarea(tarea)"
                        >
                            Editar
                        </button>
                        <button
                            class="bg-red-500 rounded-lg p-2"
                            @click="eliminar_tarea(tarea)"
                        >
                            Eliminar
                        </button>
                    </div>
            ...
            >
                <template #title>
                    ...
                    >
                        <button
                            class="bg-yellow-500 rounded-lg p-2"
                            @click="editar_foro(foro)"
                        >
                            Editar
                        </button>
                        <button
                            class="bg-red-500 rounded-lg p-2"
                            @click="eliminar_foro(foro)"
                        >
                            Eliminar
                        </button>
                    </div>
